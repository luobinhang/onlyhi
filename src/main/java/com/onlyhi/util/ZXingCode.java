...
public class ZXingCode
{
    ...
    {  
        try  
        {  
        	String uploadPath = "D:/A";
        	File dir = new File(uploadPath);
			if (!dir.exists())
	        	dir.mkdirs();
			String qrPath = uploadPath+File.separator+"a"+".PNG";
            getLogoQRCode("https://www.baidu.com/", "微信扫码支付",qrPath);
        }  
        catch (Exception e)  
        {  
            e.printStackTrace();  
     ...
     * @param logoPic
     */
    public static String getLogoQRCode(String qrUrl,String productName,String qrPath)
    {
...
//        String filePath = "C:/Users/luoguohui/Desktop/78310a55b319ebc4fa3aef658126cffc1f17168f.png";  //TODO  
        ...
        {  
            ...
            return zp.addLogo_QRCode(bim, null, new LogoConfig(), productName,qrPath);
        }
        catch (Exception e)
        {
            e.printStackTrace();
...
//            logo.flush();
            ...
            ImageIO.write(image, "png", new File(qrPath)); //TODO
