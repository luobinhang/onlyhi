...
public class ChargeExample {
    ...
    public Charge createCharge() {
        ...
        chargeMap.put("subject", "Your Subject");//课程名字
        chargeMap.put("body", "Your Body");//商品描述信息（课程名字，课程时长）
        chargeMap.put("order_no", "");// 推荐使用 8-20 位，要求数字或字母，不允许其他字符(16位)
        chargeMap.put("channel", "alipay_qr");// 支付使用的第三方支付渠道取值，请参考：https://www.pingxx.com/api#api-c-new
