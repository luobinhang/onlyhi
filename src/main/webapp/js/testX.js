...
$(function(){
  ...
  // var pieData = ["自主学习能力","基础知识学习","专注力","良好心态"];
  function test(){
    var formData = {
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data.code == 100) {
          ...
          // for(var i = 0;i<4;i++){ //需提高能力
          //  if($data.mustPromoteFeedBack.indexOf(pieData[i]) != -1){
          //    pieData.splice(i,1);
          // 	}
          // }
          var bar4Img = "";
    ...
    var option = {
      ...
      radar: {
        ...
        splitLine :{
          show:false,
          // lineStyle: {
          //   color: ["transparent","transparent","transparent","#c5c5c5","transparent","#c5c5c5",],
          //   // type:["solid	","dashed"]
          // }
      ...
      series: [{
        ...
        areaStyle: {
          ...
          //     0, 0, 0, 1,
          //     [
          //       {offset: 0, color: '#13a6a8'},
          //       {offset: 0.7, color: '#13a6a8'},
