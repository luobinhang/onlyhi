...
//返回顶部end
    ...
    //signUp05.html?adid=5VZ9ZP3LNU渠道增加js代码
    if (location.pathname.indexOf('signUp05.html') != -1) {
        signUp05();
    }
    function signUp05() {
        if(GetQueryString("adid") == '5VZ9ZP3LNU'){
            var scriptsignUp ='<script type="text/javascript" src="//yun.tuisnake.com/h5-mami/log.js" id="send_log"></script>';
            $("head").append(scriptsignUp);
        }
    ...
    (function () {
        ...
        if (location.href.indexOf('signCode') != -1||location.href.indexOf('signUp05.html') != -1||location.href.indexOf('signUp06.html') != -1){
            // ||location.href.indexOf('sign.html') != -1
            // ||location.href.indexOf('signStar.html') != -1
            // ||location.href.indexOf('signExtend.html') != -1)
    ...
    $(".submit").on("click", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //signUp05.html?adid=5VZ9ZP3LNU需要加个转化时间
                if (location.href.indexOf('signUp05.html') != -1&&GetQueryString("adid") == '5VZ9ZP3LNU') {
                    // console.log(111);
                    countLog.init()
                }
                if (data.code == 100) {
                    ...
                    $(".grade").val("请选择");
                    $(".kemu").val("请选择");
                    if (location.href.indexOf('signUp01') != -1) {
                        location.href = "./signUp01_success.html";
                    }
                    else{
